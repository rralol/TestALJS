document.write('<html><head><title>Tick-Tack-Toe</title><h2>Tick-Tack-Toe</h2></head><body><div id="container"></div><div id="announcement" data-id="announcement"></div></body></html>')
